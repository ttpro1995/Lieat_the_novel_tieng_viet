...
\begin{document}
	...
	\subsection*{Day One}
	\addcontentsline{toc}{subsection}{Day One} % add unnumber subsection to toc

	
	\subsection*{Day Two}
	\addcontentsline{toc}{subsection}{Day Two} % add unnumber subsection to toc
	
	\subsection*{Day Three}
	\addcontentsline{toc}{subsection}{Day Three} % add unnumber subsection to toc
