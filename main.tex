...
\begin{document}
	...
	\phantomsection
	\subsection*{Ngày 4}
	\addcontentsline{toc}{subsection}{Ngày 4}% add unnumber subsection to toc
	\input{3_day_four}
	
	\phantomsection
	\subsection*{Ngày 5}
	\addcontentsline{toc}{subsection}{Ngày 5} % add unnumber subsection to toc
	\input{3_day_five}
	
	\subsection*{???}
	\input{3_day_five_secret}
